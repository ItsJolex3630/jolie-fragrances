...
export const PERFUME_ACCORDS: Record<number, { label: string; percentage: number; color: string }[]> = {
  ...
  217: [
    { label: "Floral", percentage: 95, color: "#e75a8d" },
    { label: "Frutal", percentage: 82, color: "#e75a8d" },
    { label: "Dulce", percentage: 70, color: "#f0a830" },
    { label: "Cítrico", percentage: 58, color: "#f0c934" },
    { label: "Rosado", percentage: 52, color: "#e75a8d" },
    { label: "Almizclado", percentage: 45, color: "#a0a0a0" },
    { label: "Atalcado", percentage: 38, color: "#d4c5a9" },
  ],
  218: [
    { label: "Frutal", percentage: 95, color: "#e75a8d" },
    { label: "Dulce", percentage: 82, color: "#f0a830" },
    { label: "Cereza", percentage: 75, color: "#c4385a" },
    { label: "Floral", percentage: 62, color: "#e75a8d" },
    { label: "Vainilla", percentage: 55, color: "#c9a033" },
    { label: "Almizclado", percentage: 42, color: "#a0a0a0" },
    { label: "Ámbar", percentage: 35, color: "#f0a830" },
  ],
  219: [
    { label: "Avainillado", percentage: 100, color: "#c9a033" },
    { label: "Dulce", percentage: 79, color: "#f0a830" },
    { label: "Lactónico", percentage: 68, color: "#f5f0e0" },
    { label: "Cacao", percentage: 52, color: "#5a3a2a" },
    { label: "Amaderado", percentage: 35, color: "#c17b2a" },
    { label: "Atalcado", percentage: 28, color: "#d4c5a9" },
    { label: "Almizclado", percentage: 22, color: "#a0a0a0" },
  ],
  220: [
    { label: "Aromático", percentage: 95, color: "#6b8e4e" },
    ...
    { label: "Cálido Especiado", percentage: 55, color: "#c45a3a" },
    { label: "Almizclado", percentage: 48, color: "#a0a0a0" },
    { label: "Cítrico", percentage: 42, color: "#f0c934" },
  ],
  221: [
    { label: "Oud", percentage: 95, color: "#5a3a2a" },
    { label: "Amaderado", percentage: 88, color: "#c17b2a" },
    { label: "Ahumado", percentage: 72, color: "#7a6b5d" },
    { label: "Ámbar", percentage: 58, color: "#f0a830" },
    { label: "Especiado Cálido", percentage: 52, color: "#c45a3a" },
    { label: "Almizclado", percentage: 45, color: "#a0a0a0" },
    { label: "Cuero", percentage: 38, color: "#8b5e3c" },
  ],
  222: [
    { label: "Ámbar", percentage: 95, color: "#f0a830" },
    { label: "Amaderado", percentage: 78, color: "#c17b2a" },
    { label: "Floral", percentage: 65, color: "#e75a8d" },
    { label: "Especiado Cálido", percentage: 58, color: "#c45a3a" },
    { label: "Almizclado", percentage: 48, color: "#a0a0a0" },
    { label: "Dulce", percentage: 42, color: "#f0a830" },
    { label: "Atalcado", percentage: 35, color: "#d4c5a9" },
  ],
  223: [
    { label: "Dulce", percentage: 95, color: "#f0a830" },
    { label: "Caramelo", percentage: 82, color: "#c98030" },
    { label: "Café", percentage: 68, color: "#5a3a2a" },
    { label: "Vainilla", percentage: 58, color: "#c9a033" },
    { label: "Lácteo", percentage: 45, color: "#f5f0e0" },
    { label: "Ámbar", percentage: 38, color: "#f0a830" },
    { label: "Amaderado", percentage: 28, color: "#c17b2a" },
  ],
  // 224 Caramel Cascade — Paris Corner (Fragrantica)
  224: [
    { label: "Avainillado", percentage: 100, color: "#c9a033" },
    { label: "Dulce", percentage: 98, color: "#f0a830" },
    { label: "Caramelo", percentage: 89, color: "#c98030" },
    { label: "Lactónico", percentage: 69, color: "#f5f0e0" },
    { label: "Miel", percentage: 66, color: "#f0a830" },
    { label: "Atalcado", percentage: 63, color: "#d4c5a9" },
    { label: "Almizclado", percentage: 61, color: "#a0a0a0" },
    { label: "Ámbar", percentage: 56, color: "#f0a830" },
    { label: "Balsámico", percentage: 54, color: "#8b6e4e" },
  ],
  225: [
    { label: "Cítrico", percentage: 95, color: "#f0c934" },
    { label: "Amaderado", percentage: 78, color: "#c17b2a" },
    ...
    { label: "Ámbar", percentage: 48, color: "#f0a830" },
    { label: "Almizclado", percentage: 42, color: "#a0a0a0" },
    { label: "Avainillado", percentage: 35, color: "#c9a033" },
  ],
  // 226 Khair Fusion — Paris Corner (Fragrantica)
  226: [
    { label: "Frutal", percentage: 100, color: "#e75a8d" },
    { label: "Fresco", percentage: 63, color: "#a0c4e8" },
    { label: "Tropical", percentage: 59, color: "#f0c934" },
    { label: "Atalcado", percentage: 58, color: "#d4c5a9" },
    { label: "Dulce", percentage: 56, color: "#f0a830" },
    { label: "Avainillado", percentage: 56, color: "#c9a033" },
    { label: "Amaderado", percentage: 54, color: "#c17b2a" },
    { label: "Cítrico", percentage: 54, color: "#f0c934" },
    { label: "Floral", percentage: 53, color: "#e75a8d" },
  ],
  ...
  227: [
    ...
    { label: "Atalcado", percentage: 74, color: "#d4c5a9" },
    { label: "Amaderado", percentage: 66, color: "#c17b2a" },
    { label: "Frutal", percentage: 64, color: "#e75a8d" },
    { label: "Acuático", percentage: 53, color: "#5aaad4" },
  ],
  228: [
    { label: "Dulce", percentage: 95, color: "#f0a830" },
    { label: "Frutal", percentage: 78, color: "#e75a8d" },
    { label: "Caramelo", percentage: 62, color: "#c98030" },
    { label: "Vainilla", percentage: 55, color: "#c9a033" },
    { label: "Floral", percentage: 42, color: "#e75a8d" },
    { label: "Almizclado", percentage: 38, color: "#a0a0a0" },
    { label: "Ámbar", percentage: 32, color: "#f0a830" },
  ...
  230: [
    { label: "Dulce", percentage: 95, color: "#f0a830" },
    { label: "Vainilla", percentage: 82, color: "#c9a033" },
    { label: "Floral", percentage: 68, color: "#e75a8d" },
    { label: "Frutal", percentage: 55, color: "#e75a8d" },
    { label: "Ámbar", percentage: 48, color: "#f0a830" },
    { label: "Almizclado", percentage: 42, color: "#a0a0a0" },
    { label: "Atalcado", percentage: 35, color: "#d4c5a9" },
  ],
  231: [
    ...
    { label: "Amaderado", percentage: 72, color: "#c17b2a" },
    { label: "Ámbar", percentage: 58, color: "#f0a830" },
    { label: "Especiado Suave", percentage: 48, color: "#d4855a" },
    { label: "Floral", percentage: 42, color: "#e75a8d" },
    { label: "Almizclado", percentage: 35, color: "#a0a0a0" },
  ],
  ...
  232: [
    ...
    { label: "Dulce", percentage: 60, color: "#f0a830" },
    { label: "Fresco Especiado", percentage: 56, color: "#a0c4e8" },
    { label: "Frutal", percentage: 56, color: "#e75a8d" },
    { label: "Almizclado", percentage: 53, color: "#a0a0a0" },
  ],
  ...
  233: [
    ...
    { label: "Frutal", percentage: 82, color: "#e75a8d" },
    { label: "Atalcado", percentage: 64, color: "#d4c5a9" },
    { label: "Almizclado", percentage: 59, color: "#a0a0a0" },
    { label: "Cítrico", percentage: 52, color: "#f0c934" },
  ],
  ...
  234: [
    ...
    { label: "Fresco Especiado", percentage: 75, color: "#a0c4e8" },
    { label: "Oud", percentage: 74, color: "#5a3a2a" },
    { label: "Cítrico", percentage: 71, color: "#f0c934" },
    { label: "Cuero", percentage: 70, color: "#8b5e3c" },
    { label: "Amaderado", percentage: 65, color: "#c17b2a" },
    { label: "Almizclado", percentage: 64, color: "#a0a0a0" },
    { label: "Ámbar", percentage: 63, color: "#f0a830" },
    { label: "Animálico", percentage: 62, color: "#8b6e4e" },
  ],
  // 235 Khair Felicity — Paris Corner (Fragrantica)
  235: [
    { label: "Avainillado", percentage: 100, color: "#c9a033" },
    { label: "Dulce", percentage: 91, color: "#f0a830" },
    { label: "Floral", percentage: 74, color: "#e75a8d" },
    { label: "Almizclado", percentage: 70, color: "#a0a0a0" },
    { label: "Atalcado", percentage: 68, color: "#d4c5a9" },
    { label: "Champán", percentage: 64, color: "#f0c934" },
    { label: "Floral Blanco", percentage: 58, color: "#f0e6f6" },
    { label: "Especiado Suave", percentage: 58, color: "#d4855a" },
    { label: "Aldehídico", percentage: 57, color: "#a0c4e8" },
    { label: "Aromático", percentage: 54, color: "#6b8e4e" },
  ],
  // 236 December Vanilla — Paris Corner (Fragrantica)
  236: [
    { label: "Dulce", percentage: 100, color: "#f0a830" },
    { label: "Avainillado", percentage: 71, color: "#c9a033" },
    { label: "Especiado Cálido", percentage: 63, color: "#c45a3a" },
    { label: "Ron", percentage: 45, color: "#c98030" },
    { label: "Amaderado", percentage: 41, color: "#c17b2a" },
    { label: "Pachulí", percentage: 40, color: "#4a7a3a" },
    { label: "Atalcado", percentage: 29, color: "#d4c5a9" },
    { label: "Ámbar", percentage: 27, color: "#f0a830" },
    { label: "Balsámico", percentage: 24, color: "#8b6e4e" },
  ],
  ...
  237: [
    ...
    { label: "Fresco Especiado", percentage: 82, color: "#a0c4e8" },
    { label: "Ámbar", percentage: 37, color: "#f0a830" },
    { label: "Almizclado", percentage: 32, color: "#a0a0a0" },
    { label: "Fresco", percentage: 30, color: "#a0c4e8" },
    { label: "Atalcado", percentage: 25, color: "#d4c5a9" },
    { label: "Aromático", percentage: 21, color: "#6b8e4e" },
    { label: "Animálico", percentage: 12, color: "#8b6e4e" },
  ],
  ...
  238: [
    ...
    { label: "Dulce", percentage: 59, color: "#f0a830" },
    { label: "Atalcado", percentage: 46, color: "#d4c5a9" },
    { label: "Especiado Cálido", percentage: 42, color: "#c45a3a" },
    { label: "Avainillado", percentage: 42, color: "#c9a033" },
    { label: "Amaderado", percentage: 34, color: "#c17b2a" },
    { label: "Ámbar", percentage: 26, color: "#f0a830" },
    { label: "Aromático", percentage: 21, color: "#6b8e4e" },
  ],
  // 239 Taskeen Marina — Paris Corner (Fragrantica)
  239: [
    { label: "Cítrico", percentage: 100, color: "#f0c934" },
    { label: "Frutal", percentage: 57, color: "#e75a8d" },
    { label: "Floral Blanco", percentage: 48, color: "#f0e6f6" },
    { label: "Fresco Especiado", percentage: 35, color: "#a0c4e8" },
    { label: "Aromático", percentage: 31, color: "#6b8e4e" },
    { label: "Fresco", percentage: 29, color: "#a0c4e8" },
    { label: "Verde", percentage: 28, color: "#4a7a3a" },
    { label: "Floral", percentage: 22, color: "#e75a8d" },
    { label: "Especiado Suave", percentage: 17, color: "#d4855a" },
  ],
  // 240 Lactea Divina — Paris Corner (Fragrantica)
  240: [
    { label: "Avainillado", percentage: 100, color: "#c9a033" },
    { label: "Lactónico", percentage: 84, color: "#f5f0e0" },
    { label: "Floral Blanco", percentage: 73, color: "#f0e6f6" },
    { label: "Ámbar", percentage: 55, color: "#f0a830" },
    { label: "Tuberosa", percentage: 50, color: "#f0e6f6" },
    { label: "Dulce", percentage: 49, color: "#f0a830" },
    { label: "Especiado Cálido", percentage: 44, color: "#c45a3a" },
    { label: "Cacao", percentage: 34, color: "#5a3a2a" },
    { label: "Balsámico", percentage: 27, color: "#8b6e4e" },
    { label: "Ahumado", percentage: 24, color: "#7a6b5d" },
  ],
  ...
  241: [
    ...
    { label: "Floral Blanco", percentage: 58, color: "#f0e6f6" },
    { label: "Fresco", percentage: 54, color: "#a0c4e8" },
    { label: "Violeta", percentage: 50, color: "#9b8ec4" },
    { label: "Iris", percentage: 47, color: "#9b8ec4" },
    { label: "Avainillado", percentage: 38, color: "#c9a033" },
    { label: "Floral", percentage: 36, color: "#e75a8d" },
    { label: "Dulce", percentage: 36, color: "#f0a830" },
    { label: "Tropical", percentage: 28, color: "#f0c934" },
    { label: "Amaderado", percentage: 27, color: "#c17b2a" },
  ],
  // 242 Mango Punch — Paris Corner (Fragrantica)
  242: [
    { label: "Dulce", percentage: 100, color: "#f0a830" },
    { label: "Frutal", percentage: 90, color: "#e75a8d" },
    { label: "Tropical", percentage: 81, color: "#f0c934" },
    { label: "Avainillado", percentage: 37, color: "#c9a033" },
    { label: "Floral", percentage: 37, color: "#e75a8d" },
    { label: "Atalcado", percentage: 27, color: "#d4c5a9" },
    { label: "Fresco Especiado", percentage: 27, color: "#a0c4e8" },
    { label: "Iris", percentage: 27, color: "#9b8ec4" },
    { label: "Amaderado", percentage: 23, color: "#c17b2a" },
  ],
  ...
  244: [
    { label: "Frutal", percentage: 100, color: "#e75a8d" },
    { label: "Dulce", percentage: 72, color: "#f0a830" },
    { label: "Fresco", percentage: 64, color: "#a0c4e8" },
    { label: "Acuático", percentage: 55, color: "#5aaad4" },
    { label: "Verde", percentage: 54, color: "#4a7a3a" },
    { label: "Caramelo", percentage: 53, color: "#c98030" },
  ],
  // 245 Qissa Pink — Paris Corner (Fragrantica)
  245: [
    { label: "Avainillado", percentage: 100, color: "#c9a033" },
    { label: "Dulce", percentage: 89, color: "#f0a830" },
    { label: "Coco", percentage: 71, color: "#d4c5a9" },
    { label: "Atalcado", percentage: 68, color: "#d4c5a9" },
    { label: "Floral Blanco", percentage: 60, color: "#f0e6f6" },
    { label: "Amaderado", percentage: 59, color: "#c17b2a" },
    { label: "Rosado", percentage: 57, color: "#e75a8d" },
    { label: "Violeta", percentage: 57, color: "#9b8ec4" },
    { label: "Frutal", percentage: 55, color: "#e75a8d" },
    { label: "Fresco", percentage: 55, color: "#a0c4e8" },
  ],
  ...
  246: [
    { label: "Dulce", percentage: 100, color: "#f0a830" },
    { label: "Avainillado", percentage: 81, color: "#c9a033" },
    { label: "Atalcado", percentage: 67, color: "#d4c5a9" },
    { label: "Cítrico", percentage: 58, color: "#f0c934" },
    { label: "Chocolate", percentage: 56, color: "#5a3a2a" },
    { label: "Almizclado", percentage: 54, color: "#a0a0a0" },
    { label: "Lactónico", percentage: 53, color: "#f5f0e0" },
  ],
  // 247 Qissa Blue — Paris Corner (Fragrantica)
  247: [
    { label: "Cítrico", percentage: 100, color: "#f0c934" },
    { label: "Fresco Especiado", percentage: 67, color: "#a0c4e8" },
    { label: "Fresco", percentage: 58, color: "#a0c4e8" },
    { label: "Aromático", percentage: 55, color: "#6b8e4e" },
    { label: "Herbal", percentage: 52, color: "#6b8e4e" },
  ],

  // ==================== ZIMAYA (248-259) ====================
  248: [
    { label: "Ámbar", percentage: 100, color: "#f0a830" },
    { label: "Ahumado", percentage: 89, color: "#7a6b5d" },
    { label: "Cuero", percentage: 68, color: "#8b5e3c" },
    { label: "Amaderado", percentage: 67, color: "#c17b2a" },
    { label: "Fresco Especiado", percentage: 63, color: "#a0c4e8" },
    { label: "Cálido Especiado", percentage: 63, color: "#c45a3a" },
    { label: "Oud", percentage: 62, color: "#5a3a2a" },
    { label: "Balsámico", percentage: 60, color: "#8b6e4e" },
  ],
  249: [
    { label: "Dulce", percentage: 100, color: "#f0a830" },
    { label: "Vainilla", percentage: 84, color: "#c9a033" },
    { label: "Almendra", percentage: 65, color: "#d4c5a9" },
    { label: "Café", percentage: 63, color: "#5a3a2a" },
    { label: "Frutal", percentage: 62, color: "#e75a8d" },
    { label: "Cálido Especiado", percentage: 54, color: "#c45a3a" },
  ],
  250: [
    { label: "Rosa", percentage: 100, color: "#e75a8d" },
    { label: "Floral", percentage: 95, color: "#e75a8d" },
    { label: "Almizclado", percentage: 93, color: "#a0a0a0" },
    { label: "Ámbar", percentage: 84, color: "#f0a830" },
    { label: "Atalcado", percentage: 76, color: "#d4c5a9" },
    { label: "Cereza", percentage: 74, color: "#c4385a" },
    { label: "Fresco", percentage: 73, color: "#a0c4e8" },
    { label: "Cálido Especiado", percentage: 71, color: "#c45a3a" },
  ],
  251: [
    { label: "Dulce", percentage: 100, color: "#f0a830" },
    ...
    { label: "Rosa", percentage: 85, color: "#e75a8d" },
    { label: "Ozónico", percentage: 79, color: "#a0c4e8" },
    { label: "Pachulí", percentage: 76, color: "#4a7a3a" },
    { label: "Atalcado", percentage: 62, color: "#d4c5a9" },
  ],
  252: [
    { label: "Oud", percentage: 100, color: "#5a3a2a" },
    { label: "Fresco Especiado", percentage: 98, color: "#a0c4e8" },
    { label: "Cálido Especiado", percentage: 88, color: "#c45a3a" },
    { label: "Pachulí", percentage: 66, color: "#4a7a3a" },
    { label: "Lavanda", percentage: 64, color: "#9b8ec4" },
    { label: "Almizclado", percentage: 63, color: "#a0a0a0" },
    { label: "Cuero", percentage: 57, color: "#8b5e3c" },
  ],
  253: [
    { label: "Oud", percentage: 100, color: "#5a3a2a" },
    { label: "Amaderado", percentage: 97, color: "#c17b2a" },
    { label: "Tabaco", percentage: 95, color: "#5a3a2a" },
    { label: "Cuero", percentage: 89, color: "#8b5e3c" },
    { label: "Pachulí", percentage: 82, color: "#4a7a3a" },
    { label: "Ámbar", percentage: 80, color: "#f0a830" },
    { label: "Dulce", percentage: 68, color: "#f0a830" },
  ],
  254: [
    { label: "Cítrico", percentage: 100, color: "#f0c934" },
    { label: "Rosa", percentage: 95, color: "#e75a8d" },
    { label: "Aromático", percentage: 76, color: "#6b8e4e" },
    { label: "Fresco Especiado", percentage: 72, color: "#a0c4e8" },
    { label: "Almizclado", percentage: 67, color: "#a0a0a0" },
    { label: "Floral", percentage: 66, color: "#e75a8d" },
    { label: "Atalcado", percentage: 60, color: "#d4c5a9" },
  ],
  255: [
    { label: "Dulce", percentage: 100, color: "#f0a830" },
    { label: "Frutal", percentage: 99, color: "#e75a8d" },
    { label: "Floral Blanco", percentage: 96, color: "#f0e6f6" },
    { label: "Fresco", percentage: 87, color: "#a0c4e8" },
    { label: "Marino", percentage: 80, color: "#4a8eb8" },
    { label: "Tropical", percentage: 71, color: "#f0c934" },
    { label: "Atalcado", percentage: 71, color: "#d4c5a9" },
    { label: "Amaderado", percentage: 70, color: "#c17b2a" },
  ],
  256: [
    { label: "Floral Blanco", percentage: 100, color: "#f0e6f6" },
    { label: "Cítrico", percentage: 93, color: "#f0c934" },
    { label: "Tuberosa", percentage: 66, color: "#e75a8d" },
    { label: "Almizclado", percentage: 58, color: "#a0a0a0" },
    { label: "Dulce", percentage: 55, color: "#f0a830" },
    { label: "Atalcado", percentage: 54, color: "#d4c5a9" },
    { label: "Amaderado", percentage: 53, color: "#c17b2a" },
  ],
  257: [
    ...
    { label: "Almizclado", percentage: 83, color: "#a0a0a0" },
    { label: "Cítrico", percentage: 78, color: "#f0c934" },
    { label: "Floral Blanco", percentage: 78, color: "#f0e6f6" },
    { label: "Fresco", percentage: 59, color: "#a0c4e8" },
    { label: "Atalcado", percentage: 56, color: "#d4c5a9" },
    { label: "Ámbar", percentage: 54, color: "#f0a830" },
  ],
  258: [
    { label: "Ozónico", percentage: 100, color: "#a0c4e8" },
    { label: "Frutal", percentage: 82, color: "#e75a8d" },
    { label: "Marino", percentage: 82, color: "#4a8eb8" },
    { label: "Acuático", percentage: 76, color: "#5aaad4" },
    { label: "Fresco", percentage: 68, color: "#a0c4e8" },
    { label: "Aromático", percentage: 65, color: "#6b8e4e" },
    { label: "Almizclado", percentage: 59, color: "#a0a0a0" },
  ],
  259: [
    ...
    { label: "Dulce", percentage: 69, color: "#f0a830" },
    { label: "Aromático", percentage: 58, color: "#6b8e4e" },
    { label: "Especiado Cálido", percentage: 55, color: "#c45a3a" },
    { label: "Amaderado", percentage: 48, color: "#c17b2a" },
    { label: "Almizclado", percentage: 42, color: "#a0a0a0" },
    { label: "Ámbar", percentage: 35, color: "#f0a830" },
  ],
  ...
  260: [
    { label: "Dulce", percentage: 95, color: "#f0a830" },
    { label: "Vainilla", percentage: 74, color: "#c9a033" },
    { label: "Coco", percentage: 70, color: "#f5f0e0" },
    { label: "Lácteo", percentage: 52, color: "#f5f0e0" },
    { label: "Almizclado", percentage: 41, color: "#a0a0a0" },
    { label: "Caramelo", percentage: 36, color: "#f0a830" },
    { label: "Atalcado", percentage: 32, color: "#d4c5a9" },
    { label: "Floral Blanco", percentage: 22, color: "#e75a8d" },
  ],
  261: [
    { label: "Frutal", percentage: 95, color: "#e75a8d" },
    { label: "Dulce", percentage: 61, color: "#f0a830" },
    { label: "Ámbar", percentage: 48, color: "#f0a830" },
    { label: "Tropical", percentage: 22, color: "#f0c934" },
    { label: "Almizclado", percentage: 17, color: "#a0a0a0" },
    { label: "Fresco", percentage: 16, color: "#a0c4e8" },
    { label: "Rosado", percentage: 13, color: "#e75a8d" },
  ],
  262: [
    { label: "Dulce", percentage: 95, color: "#f0a830" },
    { label: "Frutal", percentage: 50, color: "#e75a8d" },
    { label: "Atalcado", percentage: 42, color: "#d4c5a9" },
    { label: "Vainilla", percentage: 36, color: "#c9a033" },
    { label: "Lácteo", percentage: 29, color: "#f5f0e0" },
    { label: "Caramelo", percentage: 28, color: "#f0a830" },
    { label: "Floral Blanco", percentage: 20, color: "#e75a8d" },
    { label: "Floral", percentage: 19, color: "#e75a8d" },
  ],
  263: [
    { label: "Dulce", percentage: 95, color: "#f0a830" },
    { label: "Lácteo", percentage: 40, color: "#f5f0e0" },
    { label: "Vainilla", percentage: 38, color: "#c9a033" },
    { label: "Frutal", percentage: 34, color: "#e75a8d" },
    { label: "Tropical", percentage: 21, color: "#f0c934" },
    { label: "Atalcado", percentage: 15, color: "#d4c5a9" },
    { label: "Almizclado", percentage: 12, color: "#a0a0a0" },
  ],
  264: [
    { label: "Tropical", percentage: 95, color: "#f0c934" },
    { label: "Frutal", percentage: 82, color: "#e75a8d" },
    { label: "Dulce", percentage: 68, color: "#f0a830" },
    { label: "Cítrico", percentage: 55, color: "#f0c934" },
    { label: "Amaderado", percentage: 42, color: "#c17b2a" },
    { label: "Especiado Cálido", percentage: 38, color: "#c45a3a" },
    { label: "Almizclado", percentage: 32, color: "#a0a0a0" },
  ],
  265: [
    { label: "Dulce", percentage: 95, color: "#f0a830" },
    { label: "Vainilla", percentage: 70, color: "#c9a033" },
    { label: "Cacao", percentage: 62, color: "#5a3a2a" },
    { label: "Caramelo", percentage: 55, color: "#c98030" },
    { label: "Amaderado", percentage: 42, color: "#c17b2a" },
    { label: "Ámbar", percentage: 38, color: "#f0a830" },
    { label: "Almizclado", percentage: 28, color: "#a0a0a0" },
  ],
  266: [
    { label: "Caramelo", percentage: 95, color: "#c98030" },
    { label: "Vainilla", percentage: 87, color: "#c9a033" },
    { label: "Dulce", percentage: 72, color: "#f0a830" },
    { label: "Ámbar", percentage: 49, color: "#f0a830" },
    { label: "Lácteo", percentage: 39, color: "#f5f0e0" },
    { label: "Balsámico", percentage: 36, color: "#8b6e4e" },
    { label: "Atalcado", percentage: 32, color: "#d4c5a9" },
    { label: "Amaderado", percentage: 31, color: "#c17b2a" },
  ],
  267: [
    { label: "Dulce", percentage: 95, color: "#f0a830" },
    { label: "Rosado", percentage: 79, color: "#e75a8d" },
    { label: "Frutal", percentage: 66, color: "#e75a8d" },
    { label: "Floral", percentage: 61, color: "#e75a8d" },
    { label: "Vainilla", percentage: 43, color: "#c9a033" },
    { label: "Coco", percentage: 39, color: "#f5f0e0" },
    { label: "Atalcado", percentage: 38, color: "#d4c5a9" },
    { label: "Fresco", percentage: 38, color: "#a0c4e8" },
  ],
  268: [
    { label: "Frutos Secos", percentage: 95, color: "#8b6e4e" },
    { label: "Atalcado", percentage: 48, color: "#d4c5a9" },
    { label: "Dulce", percentage: 48, color: "#f0a830" },
    { label: "Vainilla", percentage: 39, color: "#c9a033" },
    { label: "Amaderado", percentage: 38, color: "#c17b2a" },
    { label: "Ámbar", percentage: 35, color: "#f0a830" },
    { label: "Almendra", percentage: 34, color: "#8b6e4e" },
    { label: "Coco", percentage: 30, color: "#f5f0e0" },
  ],
  269: [
    { label: "Cítrico", percentage: 95, color: "#f0c934" },
    { label: "Vainilla", percentage: 66, color: "#c9a033" },
    { label: "Dulce", percentage: 53, color: "#f0a830" },
    { label: "Aromático", percentage: 28, color: "#6b8e4e" },
    { label: "Atalcado", percentage: 19, color: "#d4c5a9" },
    { label: "Fresco", percentage: 19, color: "#a0c4e8" },
    { label: "Balsámico", percentage: 9, color: "#8b6e4e" },
  ],
  270: [
    ...
    { label: "Vainilla", percentage: 60, color: "#c9a033" },
    { label: "Atalcado", percentage: 59, color: "#d4c5a9" },
    { label: "Coco", percentage: 55, color: "#f5f0e0" },
    { label: "Cacao", percentage: 44, color: "#5a3a2a" },
    { label: "Cálido Especiado", percentage: 39, color: "#c45a3a" },
    { label: "Almizclado", percentage: 33, color: "#a0a0a0" },
  ],
  271: [
    { label: "Dulce", percentage: 95, color: "#f0a830" },
    { label: "Lácteo", percentage: 92, color: "#f5f0e0" },
    { label: "Coco", percentage: 63, color: "#f5f0e0" },
    { label: "Frutal", percentage: 44, color: "#e75a8d" },
    { label: "Floral Blanco", percentage: 39, color: "#e75a8d" },
    { label: "Vainilla", percentage: 38, color: "#c9a033" },
    { label: "Caramelo", percentage: 30, color: "#f0a830" },
    { label: "Amaderado", percentage: 25, color: "#c17b2a" },
  ],
  272: [
    { label: "Cálido Especiado", percentage: 95, color: "#c45a3a" },
    { label: "Dulce", percentage: 69, color: "#f0a830" },
    { label: "Frutos Secos", percentage: 51, color: "#8b6e4e" },
    { label: "Canela", percentage: 45, color: "#c45a3a" },
    { label: "Lácteo", percentage: 30, color: "#f5f0e0" },
    { label: "Amaderado", percentage: 30, color: "#c17b2a" },
    { label: "Vainilla", percentage: 28, color: "#c9a033" },
    { label: "Atalcado", percentage: 8, color: "#d4c5a9" },
  ],
  273: [
    { label: "Fresco Especiado", percentage: 95, color: "#c45a3a" },
    { label: "Ámbar", percentage: 90, color: "#f0a830" },
    { label: "Cítrico", percentage: 76, color: "#f0c934" },
    { label: "Fresco", percentage: 56, color: "#a0c4e8" },
    { label: "Amaderado", percentage: 48, color: "#c17b2a" },
    { label: "Cálido Especiado", percentage: 39, color: "#c45a3a" },
    { label: "Canela", percentage: 36, color: "#c45a3a" },
    { label: "Verde", percentage: 34, color: "#6b8e4e" },
  ],
