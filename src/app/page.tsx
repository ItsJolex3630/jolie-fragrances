...
const PerfumeCard = memo(function PerfumeCard({
  ...
  return (
    <div
      ...
      style={{ animationDelay: `${Math.min(index * 0.03, 0.5)}s` }}
    >
      <div className={`card-shimmer-border relative overflow-hidden rounded-xl border border-[rgba(212,175,55,0.12)] bg-[#111111] transition-all duration-500 group-hover:border-[rgba(212,175,55,0.35)] h-full flex flex-col ${perfume.available === false ? 'opacity-75' : ''}`}>
