  ...
  return (
    ...
    >
      ...
      <div className="absolute top-3 left-3 z-20">
        <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-emerald-500/95 border border-emerald-400/50 shadow-lg shadow-emerald-500/25">
      ...
      <div className="absolute top-3 right-3 z-20">
        <span
          className={`inline-flex items-center gap-1 text-[10px] px-2.5 py-1 rounded-full border font-[family-name:var(--font-inter)] font-medium shadow-lg ${catStyle.bg} ${catStyle.border} ${catStyle.text} ${catStyle.glow}`}
        >
        ...
        <div className="relative flex flex-col items-center">
          ...
          {perfumeCount === 2 && (
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-30">
              <div className="w-8 h-8 rounded-full bg-[#d4af37]/25 border border-[#d4af37]/50 flex items-center justify-center combo-plus-pulse">
