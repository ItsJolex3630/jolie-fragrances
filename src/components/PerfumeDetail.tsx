    ...
    >
      ...
      >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          onClick={onClose}
          className="absolute top-4 right-4 z-50 p-2 rounded-full bg-black/75 border border-white/10 text-white/60 hover:text-white hover:border-white/30 transition-all"
        >
          <X className="w-5 h-5" />
        </motion.button>
        ...
        {onReturn && (
          <motion.button
            ...
            className="absolute top-4 left-4 z-50 flex items-center gap-1.5 px-3 py-2 rounded-full bg-[#d4af37]/25 border border-[#d4af37]/25 text-[#d4af37] hover:bg-[#d4af37]/25 hover:border-[#d4af37]/40 transition-all"
          >
        ...
        {isLoggedIn && (
          <motion.button
            ...
            className="absolute top-14 right-4 z-50 p-2 rounded-full transition-all duration-200 cursor-pointer"
            style={{
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="relative md:w-[40%] flex-shrink-0 bg-gradient-to-b from-[#0a0a0a] to-[#080808] flex items-center justify-center min-h-[300px] md:min-h-[500px]">
            ...
            <div className="absolute bottom-4 left-4 flex items-center gap-2">
              <span
                className={`inline-flex items-center gap-1 text-[10px] px-2.5 py-1 rounded-full border font-[family-name:var(--font-inter)] ${genderStyles[perfume.gender] || "bg-white/10 text-white/50 border-white/20"}`}
              >
                <span>{genderIcons[perfume.gender] || ""}</span>
                {perfume.gender}
              </span>
              <span className="text-[10px] px-2.5 py-1 rounded-full border border-white/10 bg-black/65 text-white/50 font-[family-name:var(--font-inter)]">
                {perfume.size}
              </span>
            </div>
          </div>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 mt-4 pt-4 border-t border-white/5">
              ...
              {retailPrice !== null && perfume.available !== false && (
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  onClick={() => { addPerfume(perfume, retailPrice); onClose(); openCart(); }}
...
653:                 </svg>
654:                 Consultar Disponibilidad
655:               </a>
656: 
657:               {/* Instagram button */}
658:               <a
659:                 href="https://www.instagram.com/jolie.fragrances.ve/"
660:                 target="_blank"
661:                 rel="noopener noreferrer"
662:                 className="group flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-[#E1306C]/15 via-[#F77737]/15 to-[#FCAF45]/15 border border-[#E1306C]/25 text-[#E1306C] hover:from-[#E1306C]/25 hover:via-[#F77737]/25 hover:to-[#FCAF45]/25 hover:border-[#E1306C]/40 transition-all duration-200 font-[family-name:var(--font-inter)] text-sm font-medium"
663:                 title="Visitar Instagram"
664:               >
665:                 <Instagram className="w-4 h-4" />
666:                 <span className="text-xs font-semibold">Instagram</span>
667:               </a>
668:             </div>
669:           </div>
670:         </div>
