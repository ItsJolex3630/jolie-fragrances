...
export const PERFUME_ACCORDS: Record<number, { label: string; percentage: number; color: string }[]> = {
  ...
  // ==================== CAROLINA HERRERA ====================
  186: [
    { label: "Oriental", percentage: 90, color: "#c45a3a" },
    { label: "Dulce", percentage: 85, color: "#d4775c" },
    { label: "Cacao", percentage: 80, color: "#8b5e3c" },
    { label: "Floral Blanco", percentage: 75, color: "#e8b4c8" },
  ...
  188: [
    { label: "Frutal", percentage: 85, color: "#e87d5c" },
  ...
  193: [
    { label: "Oriental Especiado", percentage: 80, color: "#c45a3a" },
    { label: "Amaderado", percentage: 75, color: "#8b6f47" },
  ...
  194: [
    ...
    { label: "Ahumado", percentage: 60, color: "#9b8a6e" },
  ],
  195: [
    { label: "Oriental", percentage: 85, color: "#c45a3a" },
    { label: "Cacao", percentage: 80, color: "#8b5e3c" },
    { label: "Dulce", percentage: 75, color: "#d4775c" },
    { label: "Amaderado", percentage: 70, color: "#8b6f47" },
    { label: "Incienso", percentage: 65, color: "#9b8a6e" },
  ],
  196: [
  ...
  199: [
    ...
    { label: "Licoroso", percentage: 55, color: "#9b6a8e" },
  ],
  200: [
    { label: "Amaderado Floral", percentage: 85, color: "#8b6f47" },
    { label: "Fresco", percentage: 75, color: "#4a9eb5" },
    { label: "Aromático", percentage: 70, color: "#6b8e4e" },
    { label: "Amaderado", percentage: 65, color: "#8b6f47" },
    { label: "Especiado", percentage: 55, color: "#c45a3a" },
  ],
  201: [
    { label: "Fougere Aromático", percentage: 85, color: "#6b8e4e" },
    { label: "Dulce", percentage: 80, color: "#d4775c" },
