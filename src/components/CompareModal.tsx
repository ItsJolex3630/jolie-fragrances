  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-black/90 p-4 pt-8 pb-20"
      ...
      >
        ...
        >
          {/* Header */}
          <div className="sticky top-0 z-10 bg-[#0a0a0a]/98 border-b border-[rgba(212,175,55,0.08)] px-4 sm:px-6 py-4 flex items-center justify-between">
